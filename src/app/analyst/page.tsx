...
export default function Dashboard() {
  ...
  const upcomingGames = allGames.filter(
    (game) => !game.completed && game.analyst != user?.auth_user_id
  );
  ...
  const renderTabContent = () => {
    ...
    // console.log("Booked Games:", bookedGames);
    ...
    switch (activeTab) {
      case "upcoming-games":
        //console.log("Rendering upcoming games:", upcomingGames.length);
        return (
      ...
      case "booked-games":
        //console.log("Rendering booked games:", bookedGames.length);
        return (
          <div className="max-w-6xl mx-auto p-6">
            <GamesGrid
      ...
      case "completed":
        //console.log("Rendering completed games:", completedGames.length);
        return (
          <div className="max-w-6xl mx-auto p-6">
            <CompletedGamesGrid
              games={completedGames.map((game) => ({
                ...
                homeTeam: {
                  ...
                  timeouts: 0,
                  fouls: 0,
                  players: convertToPlayerDetails(
                    game.homeLineup || [],
                    "home"
                  ),
                },
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 z-0">
        <Image
          src="/background/orangebackground.jpeg"
          alt="Background"
          fill
          priority
      ...
      <div className="relative z-10 min-h-screen">
        ...
        {isLoading ? (
          <div className="w-full max-w-6xl mx-auto p-6">
            <h2 className="text-2xl font-bold text-black mb-6 mt-6">
              AVAILABLE GAMES
            </h2>
