// app/coach/[matchid]/MatchDetails.tsx
"use client";
...
export default function MatchDetails({
  ...
  const currGame = allGames.find((game) => game.match_id === matchId);
    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 p-4">
        ...
        <header className="bg-white/10   p-6 flex flex-col items-center justify-center rounded-xl mb-6 shadow-lg shadow-orange-500/10">
              ...
              {homePrevMatches && homePrevMatches[0]?.match_date ? (
                <>
                  ...
                  <div className="text-2xl font-bold">
                    {new Date(homePrevMatches[0].match_date).toLocaleDateString(
                      "en-ZA",
                      {
                        weekday: "short",
                        year: "numeric",
                  ...
                  <div className="text-lg font-medium text-gray-700">
                    {new Date(homePrevMatches[0].match_date).toLocaleTimeString(
                      "en-ZA",
                      {
                        hour: "numeric",
                        minute: "2-digit",
          ...
          {currGame?.booked == true &&
            currGame.analyst == user?.auth_user_id &&
            !currGame.completed && (
              <button
                onClick={() => {
                  ...
                  router.push(`/coach/${matchId}/tracker?${queryParams}`);
                }}
