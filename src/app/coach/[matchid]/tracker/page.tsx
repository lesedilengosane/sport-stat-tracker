// app/coach/[matchid]/tracker/page.tsx
"use client";

import { useState, useEffect } from "react";
import { useRouter, useSearchParams } from "next/navigation";
import BasketballStatTracker from "@/components/basketball-stat-tracker";
import type { GameData, Player } from "@/types/basketball";
import { apiClient } from "@/app/utils/apiClient";
import { useAuth } from "@/app/context/AuthContext";
import { toast } from "sonner";
import { useMatches, MatchesProvider } from "@/app/context/MatchesContext";
import { Loader2 } from "lucide-react";

// ✅ The outer component wraps your logic with MatchesProvider
...
// ✅ Your actual tracker logic stays here
function StatTrackerInner() {
  ...
  const { triggerRefetch } = useMatches(); // now safe ✅
