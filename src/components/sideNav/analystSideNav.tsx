...
export function AnalystSideNav({ activeTab, onTabChange }: AnalystSideNavProps) {
    ...
    <>
      ...
      >
        <div className="p-6 pt-16 h-full flex flex-col">
          <div className="mb-8">
            <h2 className="text-xl font-bold text-black uppercase tracking-wide drop-shadow">Analyst</h2><h2  className="text-xl font-bold text-orange-400 uppercase tracking-wide drop-shadow">Dashboard</h2>
          </div>
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive
                    ? "bg-white/15 text-white shadow-lg border-1 "
                    : "text-black",
                  )}
                >
