...
export function GameCard({ date, homeTeam, awayTeam }: GameCardProps) {
  return (
    <Card className="bg-slate-800 border-slate-700 p-4 text-white transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl hover:shadow-slate-900/50 hover:bg-slate-750 cursor-pointer">
